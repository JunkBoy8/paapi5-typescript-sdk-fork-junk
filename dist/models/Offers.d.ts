...
export declare type LoyaltyPointsResource = Resources<LoyaltyPoints, 'Offers.Listings.LoyaltyPoints.'>; // この記載がなかった
...
// デフォルト export declare type ListingResource = Resources<Listing, 'Offers.Listings.'> | AvailabilityResource | ConditionResource | DeliveryInfoResource | ProgramEligibilityResource;
export declare type ListingResource = Resources<Listing, 'Offers.Listings.'> | AvailabilityResource | ConditionResource | DeliveryInfoResource | LoyaltyPointsResource | ProgramEligibilityResource;
